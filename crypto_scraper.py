...
# ---------SELF NOTE--------
# req = requests.get("https://iexcloud.io").text  # allows us to look at the following url.
#
# print(req)  # the html code would be displayed on printing the text attribute.
